package org.d3if4062.hitungbmi.ui
...
import org.d3if4062.hitungbmi.R
import org.d3if4062.hitungbmi.data.KategoriBmi
import org.d3if4062.hitungbmi.databinding.FragmentSaranBinding
    ...
    private fun updateUI(kategori : KategoriBmi) {
        ...
        when (kategori) {
            ...
            KategoriBmi.IDEAL -> {
                ...
                binding.textView.text = getString(R.string.judul_ideal)
            }
            KategoriBmi.GEMUK -> {
                actionBar?.title = getString(R.string.judul_gemuk)
                binding.imageView.setImageResource(R.drawable.gemuk)
                binding.textView.text = getString(R.string.judul_gemuk)
            }
        }
    }
}